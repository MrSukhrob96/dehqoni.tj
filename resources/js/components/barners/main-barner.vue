        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col col-sm-6">
                            <div class="banner banner-overlay">
                                ...
                                <div
                                    class="banner-content banner-content-right"
                                >
                        ...
                        <div class="col-sm-6 d-none d-sm-block">
                            <div
                                class="banner banner-overlay banner-overlay-light"
                            >
                                <a href="#">
                                    <img
                    ...
                    <div
                        class="banner banner-large banner-overlay d-none d-sm-block"
                    >
                        <a href="#">
                            <img
                ...
                <div class="col-lg-4 d-none d-lg-block">
                    <div class="banner banner-middle banner-overlay">
                        ...
                        <div class="banner-content banner-content-bottom">
                            ...
                            <!-- End .banner-subtitle -->
                            <h3 class="banner-title text-white">
                                <a href="#">Amazing <br />Lace Up Boots</a>
                            </h3>
                            <!-- End .banner-title -->
                            <div class="banner-text text-white">
                                <a href="#">from $39.00</a>
